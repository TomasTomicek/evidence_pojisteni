...
class HlavniMenu:
    def __init__(self, evidence_instance):
        ...
        self.NovyPojistenec = NovyPojistenec(self.evidence_instance)  # Vytvoření instance třídy Akce_01
        self.FiltrPojistence = FiltrPojistence(self.evidence_instance)  # Vytvoření instance třídy Akce_02
        self.EditorPojistence = EditorPojistence(self.evidence_instance)  # Vytvoření instance třídy Akce_03
    def spustit_menu(self):
        ...
        while True:
            ...
            if vyber_akce == 'h':
                ...
                if 1 <= vyber_akce <= 3:
                    if vyber_akce == 1:
                        self.NovyPojistenec.pridani_pojistence()  # Volání metody z třídy Akce_01
                    elif vyber_akce == 2:
                        self.FiltrPojistence.hledani_pojistence()  # Volání metody z třídy Akce_02
                    elif vyber_akce == 3:
                        self.EditorPojistence.editace()  # Volání metody z třídy Akce_03
                else:
